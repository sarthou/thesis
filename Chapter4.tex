...
A solution to the REG problem is thus $\solution = \langle E, \var_t \rangle$, with $E$ a referring expression in the form of a set of under-specified relations representing the \sparql{} query and $\var_t$ the variable designating the target entity $\goalindiv$.
\end{definition}
